...
2. Copy URL Google Sheet penuh atau ID sheet dari URL.
3. Buka Extensions > Apps Script.
4. Paste `Code.gs`.
5. Ganti `SPREADSHEET_ID_OR_URL` dengan URL Google Sheet atau ID-nya.
...
Penting: yang dipakai adalah URL/ID Google Sheet, bukan URL Apps Script dan bukan deployment ID.
